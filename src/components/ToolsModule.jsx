    ...
    return (
        ...
        >
            ...
            <div className="flex justify-center gap-6 relative z-10">
                ...
                {/* Jarvis Basics Toggle (time/weather/spotify/screenshot/stats - no AI needed) */}
                <button
                    onClick={onToggleJarvis}
                    className={`p-3 rounded-full border-2 transition-all duration-300 ${showJarvisWindow
                        ? 'border-cyan-300 bg-cyan-300/10 text-cyan-300 hover:bg-cyan-300/20 shadow-[0_0_15px_rgba(103,232,249,0.3)]'
                        : 'border-cyan-900 text-cyan-700 hover:border-cyan-500 hover:text-cyan-500'
                        } `}
                >
                    <Sparkles size={24} />
